<head>
    ...
    <!-- For Windows Phone -->
    <!-- CORE CSS-->
    <link href="{{asset('css/materialize5.css')}}" type="text/css" rel="stylesheet">
    <link href="{{asset('css/style.css')}}" type="text/css" rel="stylesheet">
    <link href="{{asset('css/estilos5.css')}}" type="text/css" rel="stylesheet">
    ...
    <link href="{{asset('css/jquery-jvectormap.css')}}" type="text/css" rel="stylesheet">
    <link href="{{asset('css/flag-icon.min.css')}}" type="text/css" rel="stylesheet">    
