<div id="addFPago" class="modal modal-fixed-footer" style="height: 100%; overflow: hidden;">
                                                  ...
                                                  <div class="row">                                                    
                                                    <div class="col s12">  
                                                      <div class="input-field col s12">
                                                       <div id="estado" class="chip center-align teal accent-4 white-text col s12 m6 l6 offset-m6 offset-l6">
                                                      ...
                                                      <div class="input-field col s12">
                                                        ...
                                                        <input id="banco" name="banco" type="text" maxlength="200">
                                                        <label for="banco">Banco</label>
                                                        <div id="error3" style="color: red; font-size: 12px; font-style: italic; padding-left: 3rem;"></div>
                                                      </div>  
                                                      <div class="input-field col s12">
                                                        <i class="material-icons prefix">mode_edit</i>
                                                        <input id="titular" name="titular" type="text" maxlength="200">
                                                      ...
                                                      <div class="input-field col s12">
                                                        <i class="material-icons prefix">mode_edit</i>
                                                        <input id="numero_cta" name="numero_cta" type="text" maxlength="200">
                                                        <label for="numero_cta">Nro. de Cuenta</label>
                                                        <div id="error2" style="color: red; font-size: 12px; font-style: italic; padding-left: 3rem;">                                                          
                                                        </div>
                                                      </div>   
                                                      <div class="input-field col s12">
                                                        <i class="material-icons prefix">mode_edit</i>
                                                        <input id="moneda" name="moneda" type="text" maxlength="200">
                                                        <label for="moneda">Descripción Moneda</label>
                                                        <div id="error4" style="color: red; font-size: 12px; font-style: italic; padding-left: 3rem;">                                                          
                                                        </div>
                                                      </div>   
                                                      <div class="input-field col s12">
                                                        <i class="material-icons prefix">subject</i>
                                                        <textarea id="glosa" name="glosa" class="materialize-textarea" lenght="200" maxlength="200" value="" style="height: 100px"></textarea>
