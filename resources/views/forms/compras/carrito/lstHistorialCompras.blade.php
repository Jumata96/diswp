                                  ...
                                  <?php 
                                   ...
                                   ?>
                                     ...
                                     <td class="center" style="width: 9rem">
                                      ...
                                      @if($datos->estado == 'PT')  
                                       <a href="{{ url('/seguimiento/estado') }}/{{$datos->idcarrito}}" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Seguimiento">
