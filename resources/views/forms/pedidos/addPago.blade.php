              ...
              <div class="modal-content" style="padding: 0px; overflow-y: disabled; height: 300%; background-color: #f9f9f9">
                                  ...
                                  <div class="row card-header sub-header" style="margin-top: 3.15rem; margin-left: 0rem; margin-right: 0rem; position: fixed; width: 100%; z-index: 3">
                                        <div class="col s12 m12 herramienta">                         
                                          <button id="aceptar" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" type="submit" name="action" data-position="top" data-delay="500" data-tooltip="Aceptar pago">
                                                ...
                                                <span class="card-title">Boucher</span>
                                                  ...
                                                  <div class="row">                                                    
                                                    ...
                                                    <div class="input-field col s12">
                                                      ...
                                                      <textarea id="observacion" name="observacion" class="materialize-textarea" lenght="200" style="height: 50px;">{{$datos->observacion}}</textarea>
