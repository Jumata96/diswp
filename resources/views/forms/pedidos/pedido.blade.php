                  ...
                  <div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
                        <div class="col s12 m12">
                          ...
                          <a style="margin-left: 6px"></a>                          
                            ...
                            <a  href="{{ url('/excel/exportar') }}/{{$datos->idcarrito}}" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Exportar a Excel">
                          <i class="material-icons" style="color: #7986cb ">import_export</i>
                         </a>                                  
                        </div>  
                        @include('forms.pedidos.addPago')         
...
@section('script')
  @include('forms.pedidos.scripts.rechazar')
  @include('forms.pedidos.scripts.aceptar')
@endsection
