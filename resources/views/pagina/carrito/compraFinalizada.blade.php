...
<body class="gray darken-4" onLoad="redireccionar()">  
   ...
   <div id="card-alert" class="card green">
                    <div class="card-content white-text">                    
                      ...
                      <p>Gracias por comprar en ArdiniTrading, hemos enviado un mensaje  </p>
                      <p>a tu correo electrónico, puedes ingresar a la página de inicio haciendo click boton de abajo.</p>
                    </div>
