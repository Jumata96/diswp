                                              ...
                                              <div class="s5_tab_show_slides_container_wrap_outer">
                                                 <div class="s5_tab_show_slides_wrap" id="s5_tab_show_slides_wrap_id5607379932">
                                                    <div class="s5_tab_show_slides_inner_wrap">
                                                       <div class="s5_tab_show_slide s5_tab_show_slide_inactive" id="s5_tab_show_slide1_id5607379932">
                                                                      ...
                                                                      <div class="trainer_text">
                                                                         ...
                                                                         <div class="progress_bar">
                                                                            ...
                                                                            <div class="progress_bar1">
                                                                               <div class="progress_bar2" style="width:85%" data-sr="enter left, over 2s, opacity 1, move 820px">
                                                                               </div>
                                                                            </div>
                                                                         </div>
                                                                         <div class="progress_bar">
                                                                            <h3>Strength 70%</h3>
                                                                            <div class="progress_bar1">
                                                                               <div class="progress_bar2" style="width:70%" data-sr="enter left, over 2s, opacity 1, move 820px, wait 0.2s">
                                                                               </div>
                                                                            </div>
                                                                         </div>
                                                                         <div class="progress_bar">
                                                                            <h3>Boxing 95%</h3>
                                                                            <div class="progress_bar1">
                                                                               <div class="progress_bar2" style="width:95%" data-sr="enter left, over 2s, opacity 1, move 820px, wait 0.4s">
                                                                               </div>
                                                                            </div>
                                                                         </div>
                                                                      </div>
