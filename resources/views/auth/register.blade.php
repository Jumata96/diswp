...
<body class="gray darken-4" style="background: url({{asset('images/fondo-perfil.png')}}) repeat;">
    ...
    <div class="col s12 z-depth-4 card" style="width: 25rem">
      ...
      <!--      <h6><i>Por su seguridad no revele su usuario y contraseña a terceros</i></h6>   -->
        ...
        <div class="row">
          ...
          <input type="hidden" name="usu" value="ADMIN">
          ...
          <div class="input-field col s12">
            <button type="submit" class="btn waves-effect waves-light  col s12" style="background-color: #757575; height: 44px;    background: #3949ab !important;letter-spacing: .5px;">
              Registrar</button>
          </div>
          <div class="input-field col s12">
